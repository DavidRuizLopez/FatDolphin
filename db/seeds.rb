...
gear_1 = Gear.create!(name: "Nikon Z6", price: 25, description: "Brand new, haven't used it yet.", category: "cameras", user: granpepe)
...
gear_2 = Gear.create!(name: "Nikon AF-S FX", price: 25, description: "Incredible, get it with my camera, they mix like peanut butter and jelly.", category: "lenses", user: granpepe)
...
gear_3 = Gear.create!(name: "Novo explora t5", price: 25, description: "Great stuff, trust me.", category: "tripods", user: granpepe)
...
gear_4 = Gear.create!(name: "DJI Mavic Mini Foldable", price: 25, description: "Flies like a bird, great to spy on the neighbours.", category: "drones", user: granpepe)
...
gear_5 = Gear.create!(name: "Fujifilm X-T30", price: 23, description: "Works great, only a few scratches from regular use.", category: "cameras", user: jason)
...
gear_6 = Gear.create!(name: "canon ef 50mm", price: 5, description: "It's broken, but it's cheap.", category: "lenses", user: jason)
...
gear_7 = Gear.create!(name: "Leica M3", price: 5, description: "Went to the past and stole this from a hipster, it kinda sucks.", category: "cameras", user: terminator)
...
gear_8 = Gear.create!(name: "Canon ef 75-300mm", price: 5, description: "I'll be back... with more of this ones because they are a-ma-zing!", category: "lenses", user: terminator)
...
gear_9 = Gear.create!(name: "Sony A7 III", price: 19, description: "It's new, my granma gave me this for christmas but I don't like photography.", category: "cameras", user: fernando)
...
gear_10 = Gear.create!(name: "Blackmagick poket cinema camera", price: 30, description: "I use it all the time! great image and everything works!.", category: "cameras", user: charlotte)
...
gear_11 = Gear.create!(name: "Bvanguard VEO", price: 17, description: "It doesn't fly, but you can hold it as a camera, the stabilizer is superb.", category: "drones", user: charlotte)
